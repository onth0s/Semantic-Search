...
# Content Search Tier Confidence Levels
CONTENT_TIER_EXACT_TOKEN: float = 0.95
CONTENT_TIER_CI_TOKEN: float = 0.85
CONTENT_TIER_EXACT_SUBSTRING: float = 0.75
CONTENT_TIER_CI_SUBSTRING: float = 0.65
CONTENT_TIER_DELIMITED: float = 0.60
